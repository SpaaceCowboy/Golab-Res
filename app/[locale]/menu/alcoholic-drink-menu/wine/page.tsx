...
import { wine,subcategory } from "@/lib/data";
...
export default function Wine() {
  ...
  const categories = Array.from(new Set(wine.map(item => item.category)));
  ...
  />
    <div className="container-custom">       
      {!searchTerm && categories.map((category) => {
        const categoryItems = wine.filter(item => item.category === category);
