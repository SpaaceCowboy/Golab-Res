...
import { beer,subcategory } from "@/lib/data";
...
export default function Beer() {
  ...
  const categories = Array.from(new Set(beer.map(item => item.category)));
  ...
  />
    <div className="container-custom">       
      {!searchTerm && categories.map((category) => {
        const categoryItems = beer.filter(item => item.category === category);
