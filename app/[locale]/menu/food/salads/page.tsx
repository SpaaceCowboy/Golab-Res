...
import { salads,subcategory} from "@/lib/data";
...
export default function Salads() {
  ...
  const categories = Array.from(new Set(salads.map(item => item.category)));
  ...
  />
    <div className="container-custom">       
      {!searchTerm && categories.map((category) => {
        const categoryItems = salads.filter(item => item.category === category);
