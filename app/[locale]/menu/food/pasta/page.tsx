...
import { pasta,subcategory } from "@/lib/data";
...
export default function Pasta() {
  ...
  const categories = Array.from(new Set(pasta.map(item => item.category)));
  ...
  />
    <div className="container-custom">       
      {!searchTerm && categories.map((category) => {
        const categoryItems = pasta.filter(item => item.category === category);
