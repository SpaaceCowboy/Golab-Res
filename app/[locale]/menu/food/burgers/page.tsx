...
import { burger,subcategory } from "@/lib/data";
...
export default function Burgers() {
  ...
  const categories = Array.from(new Set(burger.map(item => item.category)));
    ...
    />
      <div className="container-custom">
        ...
        {!searchTerm && categories.map((category) => {
          ...
          return (
            <div key={category} id={category.toLowerCase().replace(/\s+/g, '-')} className="mt-[20vh] md:mt-0 mb-16 scroll-mt-24 lg:mt-0">
